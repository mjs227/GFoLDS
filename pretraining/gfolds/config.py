...
BASE_DATA_FILEPATH = f'{FILEPATH}data/batch_data/0/'  # no effect if RANDOMIZE_BATCHES = False
BATCH_FILEPATH = f'{FILEPATH}data/batch_data/'  # empty if RANDOMIZE_BATCHES, else folders {0, ..., N_EPOCHS}
